 ...
 */
export function renderOutro({ outroLogoSvg, photoPath, outroCta, glow = '#7D2AE8' }) {
...
<div class="slide">
  ...
  <div class="outro-glow">
    <svg viewBox="0 0 1581 1547" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g filter="url(#og)"><path d="M1081 717.532C1081 899.492 950.939 1047 790.5 1047C630.061 1047 500 899.492 500 717.532C500 535.571 630.061 500 790.5 500C950.939 500 1081 535.571 1081 717.532Z" fill="${glow}"/></g>
