...
Run the bundled validator to check every skill at once:
...
**Valid**: `infographic`, `linkedin-poster`, `x-card-generator`
**Invalid**: `Infographic`, `-poster`, `linkedin--poster`
...
- Second person ("You are an infographic generation expert")
...
```yaml
description: Generate "HOW X WORKS" educational infographic diagrams. Use when the user wants an infographic, a "how X works" diagram, or an educational visual for a backend or Java topic.
```
...
- `fix: improve clarity in infographic`
- `docs: update README`
...
See `README.md` for the current list of skills. When adding new skills, follow the naming patterns of existing skills in the repo.
