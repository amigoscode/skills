...
Thanks for your interest in contributing to Amigoscode Skills! This guide will help you add new skills or improve existing ones.
...
- **Directory name**: lowercase, hyphens only (e.g., `linkedin-poster`)
